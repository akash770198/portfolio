    ...
    <section id='experience' className='py-32 relative overflow-hidden'>
      ...
      <div className='container mx-auto px-6 relative z-10'>
        ...
        <div className='max-w-3xl mb-16'>
          ...
          <h2 className='text-4xl md:text-5xl font-bold leading-tight animate-fade-in animation-delay-100 text-secondary-foreground'>Experience that <span className='font-serif italic font-normal text-white'>speaks volumes.</span>
          </h2>
          ...
          >
            A timeline of my learning journey as a developer, gaining hands-on
            experience through internships, projects, and real-world application
            development.
          </p>
        </div>
